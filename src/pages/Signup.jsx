...
const SignUp = () => {
  ...
  return (
    ...
    >
      ...
      {/* Logo and Title */}
      <div className="flex flex-col items-center justify-center gap-2 mb-8 z-10">
        <svg
          width="41"
          height="40"
          viewBox="0 0 41 40"
        ...
        <div>
          <span className="text-white text-[50px] !font-bold font-poppins">
            Sign Up to{" "}
          </span>
          <span className="bg-gradient-to-r from-[#9945FF] to-[#14F195] bg-clip-text text-transparent text-[50px] !font-bold font-poppins">
            MealCheap
          </span>
        </div>
      </div>
        ...
        <div className="relative z-10 w-full max-w-[760px]">
          ...
          <div className="relative">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 relative z-10">
              ...
              {/* External Signup Options */}
              <div className="mb-6">
                <h3 className="text-[#374151] font-normal text-2xl mb-4 text-center">
                  Sign Up with:
                </h3>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <button className="flex items-center justify-center gap-2 bg-white border border-gray-200 rounded-lg px-4 py-3 text-md font-poppins font-semibold text-[#374151] hover:bg-gray-50 transition-colors">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                  <label className="block text-xl font-poppins font-normal text-[#374151] mb-2">
                    Username or email
                  </label>
                  <div className="relative">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="block text-xl font-poppins font-normal text-[#374151]">
                      Password
                    </label>
                    {/* <Link
                      to="/forget-password"
                      className="text-lg font-poppins font-normal text-[#374151] hover:text-purple-600 transition-colors"
                    >
                      Forgot Password?
                    </Link> */}
                  </div>
                  ...
                  <div className="flex items-start">
                    <button
                      ...
                      onClick={() => {
                        ...
                        setValue("referralCode", !currentValue);
                      }}
                    >
                      {watch("referralCode") && (
              ...
              <div className="text-center mt-6">
                <span className="text-[#374151] text-2xl">
                  Already have an Account?{" "}
                </span>
                <Link
                  to="/login"
                  className="font-normal text-2xl bg-[linear-gradient(90deg,_#9945FF_0%,_#14F195_100%)] bg-clip-text text-transparent"
                >
                  Login
                </Link>
              </div>
